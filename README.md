...
📜 Descrição
 ...
 Neste projeto houve a construção de um sistema para simular alertas de irrigação, avalidando nutrientes presentes no solo, nível da água, temperatura e PH.
...
- Botões - Para simular a presença ou ausência de Fósforo e Potássio no solo
...
Acesse o Projeto no Wokwi (https://wokwi.com/projects/414489362124388353)
